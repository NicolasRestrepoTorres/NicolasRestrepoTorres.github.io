    ...
    <nav class="navbar navbar-expand-lg fixed-top dark-bg">
      ...
      <div id="navbarNavAltMarkup" class="collapse navbar-collapse">
        <ul id="navbar-nav" class="navbar-nav ml-auto">
          ...
          <li><a class="nav-item nav-link" href="#education">Education</a></li>
          <li><a class="nav-item nav-link" href="#experience">Professional Experience</a></li>
          <li><a class="nav-item nav-link" href="#skills">Skills</a></li>
          <li><a class="nav-item nav-link" href="#portfolio">Languages and Awards</a></li>
          <li><a class="nav-item nav-link" href="#project">Major School Projects</a></li>
        </ul>
      </div>
    </nav>
    <Banner />
